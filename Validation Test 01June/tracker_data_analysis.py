...
hip2proxy_inhip = vec_in_new_coord_system(hip2proxy, hip_basis)
normal_009 = (hip2proxy_inhip - pin_hip_009)/np.linalg.norm(hip2proxy_inhip - pin_hip_009)
normal_010 = (hip2proxy_inhip - pin_hip_010)/np.linalg.norm(hip2proxy_inhip - pin_hip_010)
normal_011 = (hip2proxy_inhip - pin_hip_011)/np.linalg.norm(hip2proxy_inhip - pin_hip_011)
normal_012 = (hip2proxy_inhip - pin_hip_012)/np.linalg.norm(hip2proxy_inhip - pin_hip_012)
normal_013 = (hip2proxy_inhip - pin_hip_013)/np.linalg.norm(hip2proxy_inhip - pin_hip_013)

fig = pl.figure()
ax = pl.axes(projection='3d')
ax.scatter(pin_hip_009[:,0], pin_hip_009[:,1], pin_hip_009[:,2], label="Pin position 009", c='blue')
ax.quiver(pin_hip_009[:,0], pin_hip_009[:,1], pin_hip_009[:,2], normal_009[0,0]*50, normal_009[0,1]*50, normal_009[0,2]*50,color="blue")
ax.scatter(pin_hip_010[:,0], pin_hip_010[:,1], pin_hip_010[:,2], label="Pin position 010", c='orange')
ax.quiver(pin_hip_010[:,0], pin_hip_010[:,1], pin_hip_010[:,2], normal_010[0,0]*50, normal_010[0,1]*50, normal_010[0,2]*50,color="orange")
ax.scatter(pin_hip_011[:,0], pin_hip_011[:,1], pin_hip_011[:,2], label="Pin position 011")
ax.quiver(pin_hip_011[:,0], pin_hip_011[:,1], pin_hip_011[:,2], normal_011[0,0]*50, normal_011[0,1]*50, normal_011[0,2]*50)
ax.scatter(pin_hip_012[:,0], pin_hip_012[:,1], pin_hip_012[:,2], label="Pin position 012")
ax.quiver(pin_hip_012[:,0], pin_hip_012[:,1], pin_hip_012[:,2], normal_012[0,0]*50, normal_012[0,1]*50, normal_012[0,2]*50)
ax.scatter(pin_hip_013[:,0], pin_hip_013[:,1], pin_hip_013[:,2], label="Pin position 013")
ax.quiver(pin_hip_013[:,0], pin_hip_013[:,1], pin_hip_013[:,2], normal_013[0,0]*50, normal_013[0,1]*50, normal_013[0,2]*50)
ax.scatter(probe_hip_009[:,0], probe_hip_009[:,1], probe_hip_009[:,2], label="Whitesides 009", c='purple')
ax.scatter(probe_hip_010[:,0], probe_hip_010[:,1], probe_hip_010[:,2], label="Whitesides 010", c='red')
ax.scatter(probe_hip_011[:,0], probe_hip_011[:,1], probe_hip_011[:,2], label="Whitesides 011")
ax.scatter(probe_hip_012[:,0], probe_hip_012[:,1], probe_hip_012[:,2], label="Whitesides 012")
...
proj_exp_009 = np.cross(normal_009, np.cross(probe_hip_009, normal_009))
proj_exp_010 = np.cross(normal_010, np.cross(probe_hip_010, normal_010))
proj_exp_011 = np.cross(normal_011, np.cross(probe_hip_011, normal_011))
proj_exp_012 = np.cross(normal_012, np.cross(probe_hip_012, normal_012))
proj_exp_013 = np.cross(normal_013, np.cross(probe_hip_013, normal_013))


pl.scatter(proj_exp_009[:,0], proj_exp_009[:,1])
pl.scatter(proj_exp_010[:,0], proj_exp_010[:,1])
pl.scatter(proj_exp_011[:,0], proj_exp_011[:,1])
pl.scatter(proj_exp_012[:,0], proj_exp_012[:,1])
pl.scatter(proj_exp_013[:,0], proj_exp_013[:,1])
pl.show()
